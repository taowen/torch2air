...
Q4K_LINEAR_SPIKE2_FUNCTION = "q4k_linear_spike2"
Q4K_LINEAR_SPIKE2_TILE_FUNCTION = "q4k_linear_spike2_tile"
Q4K_LINEAR_SPIKE2_LINK_OBJECT = "q4k_linear_spike2.o"
Q4K_LINEAR_SPIKE2_HIDDEN_SIZE = 1024
Q4K_LINEAR_SPIKE2_OUTPUT_TILE_ROWS = 16


def build_q4k_linear_spike2_air(
    *,
    function_name: str = Q4K_LINEAR_SPIKE2_FUNCTION,
    hidden_size: int = Q4K_LINEAR_SPIKE2_HIDDEN_SIZE,
    output_tile_rows: int = Q4K_LINEAR_SPIKE2_OUTPUT_TILE_ROWS,
) -> Module:
    if hidden_size <= 0:
